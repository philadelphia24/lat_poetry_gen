...
import re
import data_keras as data  # Import the Dictionary and Corpus classes from data.py
import argparse
import numpy as np
...
def create_syllable_dict(tokenizer, output_file, manual_updates):
    syllable_dict = {}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_file', type=str, default='/home/pricie/cclstudent10/pytorch_model/ophelia/examples/word_language_model/syllable_dictionaries/syllable_10mil_50k_dict_KERAS.json',  # CHANGE 
                        help='Output file path for the syllable dictionary')
    parser.add_argument('--tokenizer', type=str, default='/home/pricie/cclstudent10/latin_poetry/ten_million/tokenizer_train_10mio_with_EOS.pickle') # CHANGE 
    ...
    corpus = data.Corpus('/home/pricie/cclstudent10/pytorch_model/ophelia/examples/word_language_model/data/corpus_10mio_50k', tokenizer)  # CHANGE
